...
|:----|
| **Detalle:** El empleador accedera a un dispositivo para ingresar a la plataforma. La plataforma pedira al usuario tres validaciones para acceder a su informacion personal y posteriormente a la utilizacion de la Plataforma  <br> 
|**Precondición:** <br> :one: El usuario Tendra que ingresar su numero de empleado<br> :two: El usuario Tendra que ingresar su nombre de usuario<br> :three: El usuario ingresara su contraseña Personal
|**Secuencia normal** <br> :one: El usuario presionara el boton Inicio de Sesion<br> :two: El sistema verificara que las validaciones proporcionadas por el usuario sean correctas  <br> :three: Se generara un registro de la fecha y hora en la que el usuario Inicio Sesion  <br> :four: El Usuario Accedera a la pagina Princiapl de la Plataforma <br>
|**Post-condición** <br> :one: En la Pagina Principal el Usuario tendra la opcion de Cerrar Sesion  
|**Excepciones** <br> :one: En caso de que las validaciones del usuario sea Incorrectar tendran una opcion para volver a ingresar las validaciones|

|📁 **Requisito RFN-02: Descargas**  |
|:----|
...
|📁 **Requisito RFN-03: Visualizacion de Topicos**  |
|:----|
...
|📁 **Requisito RFN-04: Topicos relacionados**  |
|:----|
...
|📁 **Requisito RFN-05: Almacenamiento**  |
|:----|
...
|📁 **Requisito RFN-07: Eliminacion de Usuarios**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-08: Modificacion de Topicos**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
...
|📁 **Requisito RFN-10: Control de Usuarios**  |
|:----|
| **Detalle:** <br> 
|**Precondición:** <br> :one: <br> :two: <br> :three: |
|**Secuencia normal** <br> :one: <br> :two:  <br> :three:  <br> :four:  <br>
