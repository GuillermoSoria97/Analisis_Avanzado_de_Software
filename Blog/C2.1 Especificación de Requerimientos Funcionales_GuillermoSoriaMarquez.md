...
|**Secuencia normal** <br> :one: El usuario ingresara su nombre usuario y contraseña<br> :two: El sistema verificara que las validaciones proporcionadas por el usuario sean correctas  <br> :three: Se generara un registro de la fecha y hora en la que el usuario Inicio Sesion  <br> :four: El Usuario Accedera a la pagina Princiapl de la Plataforma <br>
