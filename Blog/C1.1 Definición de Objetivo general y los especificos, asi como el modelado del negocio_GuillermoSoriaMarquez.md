...
Incrementar el negocio mediante una plataforma web y/o movil que permita mostrar la información previamente solicitada a los usuarios y a su vez obtener mayores ganancias
1. Especifique tres **objetivos específicos**, recordándose que deben ser medibles, cuantificables y logrables.
2. Elabore el diagrama del **modelo del negocio** que se visualiza para el caso de estudio, utilizando BPMN y la herramienta case Bizagi.
![Bizagi](../Diagramas/BPMN.png)
___
